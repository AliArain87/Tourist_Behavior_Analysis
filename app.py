...
if selected == 'Introduction':
    ...
    with c2:
        ...
        st.markdown('##### [![LinkedIn](https://brand.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Bug.svg.original.svg)](https://www.linkedin.com/in/ali-hasnain-8b047a210/)')
    st.markdown('''
    #### This Web-App is developed by **Ali Hasnain** as a part of his **Big Data Analytics internship at NAVTTC**.
